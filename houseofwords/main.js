...
let face = "personal selfless offering to the world"; /*Between the quotation marks, 
...
let red = "liquid rage hunger and pain"; //repeat the instructions with the word "red" (keep in the form of a noun)

let brain = "hub of one's self"; //repeat the instructions for the word "brain"

let masculine = "unbridled aggression and sharpness"; //define 'masculine' in ADJECCTIVE form, so 
//you could sub it into a sentence that uses the word as an ADJECTIVE

let think = "meander in a flow of ideas"; //define 'think' in VERB form,
